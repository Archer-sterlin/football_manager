...
from .serializers import (PlayerInfoUpdateSerializer, RegisterSerializer,
                          SetPlayerOnTransferSerializer,
                          EditTeamSerializer, TeamsSerializer,
                          TransferMarketSerializer, TransferPlayerSerializer,
                          UserLoginSerializer)
