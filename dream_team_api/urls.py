...
from .views import (LoginView, LogoutView, PlayerInfoUpdateView,
                    PlayersListView, PlayerView, RegisterApiView,
                    SetPlayerOnTransferView, EditTeamView, TeamListView,
                    TeamView, TransferMarketList, TransferPlayer)
