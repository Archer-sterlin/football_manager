    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('market_value', models.FloatField(default=0, validators=[django.core.validators.MinValueValidator(0)])),
                ('position', models.CharField(blank=True, choices=[('GK', 'Goal_Keeper'), ('DF', 'Defender'), ('MF', 'Midfielder'), ('A', 'Attacker')], max_length=20)),
                ('shirt_number', models.IntegerField(default=1, validators=[django.core.validators.MinValueValidator(1)])),
                ('country', models.CharField(max_length=255)),
                ('player_value', models.FloatField(default=1000000, validators=[django.core.validators.MinValueValidator(1)])),
                ('transfer_status', models.CharField(choices=[('UA', 'Unavaliable'), ('A', 'Avaliable')], default='UA', max_length=20)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('team', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='dream_team_api.team')),
            ],
        ),
    ]
